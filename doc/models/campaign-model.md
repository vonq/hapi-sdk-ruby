...
| `ordered_products_specs` | [`Array<OrderedProductsGetElementModel>`](../../doc/models/ordered-products-get-element-model.md) | Optional | This part contains information of the ordered products. |
| `postings` | [`Array<CampaignPostingModel>`](../../doc/models/campaign-posting-model.md) | Optional | - |
